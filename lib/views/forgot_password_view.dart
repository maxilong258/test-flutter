...
import 'package:flutter_of_my_test/components/password_reset_email_sent_dialog.dart';
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) async {
        if (state is AuthStateForgotPassowrd) {
              ...
              TextButton(
                onPressed: () {
                  ...
                  context.read<AuthBloc>().add(
                    AuthEventForgotPassowrd(email: email)
                  );
                },
