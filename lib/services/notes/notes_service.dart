...
// import 'package:flutter_of_my_test/services/notes/notes_exceptions.dart';
// import 'package:flutter_of_my_test/utils/filter.dart';
...
//         .update(noteTable, {textColumn: text, isSyncedWithCloudColumn: 0}, where: 'id = ?', whereArgs: [note.id]);
//     if (updatesCount == 0) {
